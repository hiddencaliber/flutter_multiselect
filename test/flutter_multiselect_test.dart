...
void main() {
  ...
  testWidgets('Clicking on MultiSelect loads selection modal',
    ...
    var app = getBasicMultiSelectApp(
        multiSelect, mockNavigatorObserver, GlobalKey<FormState>());
  ...
  testWidgets('Selection has matching initialValues passed in',
      (WidgetTester tester) async {
    final MockNavigatorObserver mockNavigatorObserver = MockNavigatorObserver();
    ...
    Finder optionsThatExistFinder =
        find.descendant(of: selectionModalFinder, matching: find.byType(Chip));
